...
@onready var animation_player_man = $man2/man2/AnimationPlayer
...
func change_reticle(reticle):
	return # Yup, this function is kinda strange
	if RETICLE:
		RETICLE.queue_free()
...
func _physics_process(delta):
	man_2.global_position = global_position
	man_2.global_rotation.y = HEAD.global_rotation.y
...
func handle_animation():
	...
	if velocity.y != 0:
		animation_player_man.play("Armature_001|mixamo_com|Layer0",0.2)
	elif velocity == Vector3.ZERO:
		animation_player_man.play("Armature|mixamo_com|Layer0",0.2)
	else:
		animation_player_man.play("Armature_002|mixamo_com|Layer0",0.2)
